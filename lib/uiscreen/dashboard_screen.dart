      ...
      home: Scaffold(
        ...
        body: SafeArea(
          child: GetBuilder<DashboardController>(
            builder: (dashboardData) {
              return dashboardData.isLoading ? SizedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ReusableDashboardTile(
                              ...
                              title: 'All Open',
                              count: dashboardData.getList[0].data!.ticketHighlights?.allOpen ?? "00",
                            ),
                            ReusableDashboardTile(
                              gradientColors: [ColorConstants.dashboardColor4, ColorConstants.dashboardColor5],
                              iconPath: 'assets/images/icon6.png',
                              title: 'Quick Support',
                              count: dashboardData.getList[0].data!.ticketHighlights?.quickSupport ?? "00",
                            ),
                            ReusableDashboardTile(
                              gradientColors: [ColorConstants.dashboardColor6, ColorConstants.dashboardColor7],
                              iconPath: 'assets/images/icon7.png',
                              title: 'Due Today',
                              count: dashboardData.getList[0].data!.ticketHighlights?.dueToday ?? "00",
                            ),
                            ReusableDashboardTile(
                              gradientColors: [ColorConstants.dashboardColor8, ColorConstants.dashboardColor9],
                              iconPath: 'assets/images/icon7.png',
                              title: 'Timeline Required',
                              count: dashboardData.getList[0].data!.ticketHighlights?.timelineRequired ?? "00",
                            ),
                            ReusableDashboardTile(
                              gradientColors: [ColorConstants.dashboardColor10, ColorConstants.dashboardColor11],
                              iconPath: 'assets/images/icon8.png',
                              title: 'Overdue',
                              count: dashboardData.getList[0].data!.ticketHighlights?.overDue ?? "00",
                            ),
                            ReusableDashboardTile(
                              gradientColors: [ColorConstants.dashboardColor2, ColorConstants.dashboardColor3],
                              iconPath: 'assets/images/icon7.png',
                              title: 'Un Assign',
                              count: dashboardData.getList[0].data!.ticketHighlights?.unAssigned ?? "00",
                            ),
                            SizedBox(height: 15),
                            Text(
                            ...
                            Row(
                              children: [
                                CircularProgressBarWithLabel(progress: double.tryParse(dashboardData.getList[0].data!.ticketClosureRatioUHF?.mtd ?? "0") ?? 0.0),
                                SizedBox(width: 15,),
                                CircularProgressBarWithLabel2(progress: double.tryParse(dashboardData.getList[0].data!.ticketClosureRatioUHF?.ytd ?? "0") ?? 0.0),
                              ],
                            ),
                            SizedBox(height: 15),
                            Text(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomPaint(
            ...
            painter: CircularProgressBarPainter(progress: progress / 100), // 72% progress
          ),
        ],
      ),
    );
